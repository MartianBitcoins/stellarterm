        ...
        <ErrorBoundary>
            ...
            <Generic noTopPadding>
                ...
                <p>
                    ...
                    the funds. However, money is <strong>NOT</strong> actually <em>{'"inside"'}</em> BitgamePro.
                    BitgamePro is just a helpful tool that helps you use your secret key to make transactions.
                </p>
